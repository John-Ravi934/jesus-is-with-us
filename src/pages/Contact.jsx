          ...
          <div className={styles.contactFormWrapper} id="contact-form-section">
            ...
            <div style={{ marginTop: '3rem', textAlign: 'center', borderTop: '1px solid #eee', paddingTop: '2rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
                ...
                <a href="#" className={styles.socialIcon} style={{ padding: '0.8rem', background: '#f5f5f5', borderRadius: '50%', color: 'var(--color-primary-pink)', display: 'inline-flex', transition: 'all 0.3s ease' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                <a href="#" className={styles.socialIcon} style={{ padding: '0.8rem', background: '#f5f5f5', borderRadius: '50%', color: '#ff0000', display: 'inline-flex', transition: 'all 0.3s ease' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"></path><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"></polygon></svg>
                </a>
                <a href="#" className={styles.socialIcon} style={{ padding: '0.8rem', background: '#f5f5f5', borderRadius: '50%', color: '#1da1f2', display: 'inline-flex', transition: 'all 0.3s ease' }}>
