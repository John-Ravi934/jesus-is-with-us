        ...
        <div className={`container ${styles.contactGrid}`}>
          ...
          <div className={styles.contactFormWrapper} id="contact-form-section">
            ...
            >
              ...
              <button data-aos="fade-up" type="submit" className="btn btn-primary" disabled={isSubmitting}>
            ...
            <div style={{ marginTop: '3rem', textAlign: 'center', borderTop: '1px solid #eee', paddingTop: '2rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
                <a data-aos="fade-up" href="#" className={styles.socialIcon} style={{ padding: '0.8rem', background: '#f5f5f5', borderRadius: '50%', color: 'var(--color-primary-blue)', display: 'inline-flex', transition: 'all 0.3s ease' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                </a>
                <a data-aos="fade-up" href="#" className={styles.socialIcon} style={{ padding: '0.8rem', background: '#f5f5f5', borderRadius: '50%', color: 'var(--color-primary-pink)', display: 'inline-flex', transition: 'all 0.3s ease' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                <a data-aos="fade-up" href="#" className={styles.socialIcon} style={{ padding: '0.8rem', background: '#f5f5f5', borderRadius: '50%', color: '#ff0000', display: 'inline-flex', transition: 'all 0.3s ease' }}>
