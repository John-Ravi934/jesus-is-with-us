        ...
        <div style={{ background: '#ffffff', padding: '4rem 0' }}>
          <div className={`container ${styles.aboutBlock}`} style={{ marginTop: 0, marginBottom: 0 }}>
            ...
            <div className={styles.aboutImageRight}>
              <img src="src\assets\Church image.jpg" alt="Our Story" className={styles.roundedOrganic} />
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#f5f5f5', padding: '4rem 0' }}>
          <div className={`container ${styles.aboutBlock} ${styles.reverseBlock}`} style={{ marginTop: 0, marginBottom: 0 }}>
            <div className={styles.aboutImageLeft}>
              <img src="src\assets\Israel Pastor.png" alt="Founder" className={styles.roundedOrganicAlt} />
            </div>
            <div className={styles.aboutText}>
          ...
          <div className={styles.timeline}>
            <div className={styles.timelineItem}>
              ...
              <div className={styles.timelineContentWrapper}>
                <div className={styles.timelineContent}>
                  ...
                  <p>Started as a small prayer group in a living room with just 5 members under Pastor Israel Raj.</p>
                </div>
                <div className={styles.timelineImage}>
                  <img src="https://images.unsplash.com/photo-1544427920-c49ccf08c146?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" alt="Humble Beginning" className={styles.roundedOrganicAlt} />
                </div>
              </div>
            </div>
            ...
            <div className={styles.timelineItem}>
              ...
              <div className={`${styles.timelineContentWrapper} ${styles.timelineReverse}`}>
                ...
                <div className={styles.timelineImage}>
                  <img src="https://images.unsplash.com/photo-1548625361-ecceabcce8d0?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" alt="First Church" className={styles.roundedOrganic} />
                </div>
              </div>
            </div>
            ...
            <div className={styles.timelineItem}>
              ...
              <div className={styles.timelineContentWrapper}>
                ...
                <div className={styles.timelineImage}>
                  <img src="https://images.unsplash.com/photo-1494200483035-db7bc6aa5739?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" alt="Global Outreach" className={styles.roundedOrganicAlt} />
                </div>
              </div>
            </div>
            ...
            <div className={styles.timelineItem}>
              ...
              <div className={`${styles.timelineContentWrapper} ${styles.timelineReverse}`}>
                <div className={styles.timelineContent}>
                  ...
                  <p>Pastor Yoseppu took over the leadership, bringing a renewed focus on youth ministry and digital evangelism.</p>
                </div>
                <div className={styles.timelineImage}>
                  <img src="https://images.unsplash.com/photo-1511895426328-dc8714191300?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80" alt="New Leadership" className={styles.roundedOrganic} />
                </div>
              </div>
            </div>
          </div>
