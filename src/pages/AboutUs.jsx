        ...
        <div style={{ background: '#ffffff', padding: '4rem 0' }}>
          <div className={`container ${styles.aboutBlock}`} style={{ marginTop: 0, marginBottom: 0 }}>
            ...
            <div className={styles.aboutImageRight}>
              <img data-aos="fade-up" src="public\assets\Church image.jpg" alt="Our Story" className={styles.roundedOrganic} />
            </div>
          </div>
        </div>
        ...
        <div style={{ background: '#f5f5f5', padding: '4rem 0' }}>
          <div className={`container ${styles.aboutBlock} ${styles.reverseBlock}`} style={{ marginTop: 0, marginBottom: 0 }}>
            <div className={styles.aboutImageLeft}>
              <img data-aos="fade-up" src="public\assets\Israel Pastor.png" alt="Founder" className={styles.roundedOrganicAlt} />
            </div>
            <div className={styles.aboutText}>
          ...
          <div className={styles.timeline} data-aos="fade-up">
            <div className={styles.timelineItem} data-aos="fade-up">
              ...
              <div className={styles.timelineContentWrapper}>
                ...
                <div className={styles.timelineImage}>
                  <img data-aos="fade-up" src="public\assets\Family Ministries.png" alt="Humble Beginning" className={styles.roundedOrganicAlt} />
                </div>
              </div>
            </div>
            ...
            <div className={styles.timelineItem} data-aos="fade-up">
              ...
              <div className={`${styles.timelineContentWrapper} ${styles.timelineReverse}`}>
                ...
                <div className={styles.timelineImage}>
                  <img data-aos="fade-up" src="public\assets\Family Ministries.png" alt="First Church" className={styles.roundedOrganic} />
                </div>
              </div>
            </div>
            ...
            <div className={styles.timelineItem} data-aos="fade-up">
              ...
              <div className={styles.timelineContentWrapper}>
                ...
                <div className={styles.timelineImage}>
                  <img data-aos="fade-up" src="public\assets\Family Ministries.png" alt="Global Outreach" className={styles.roundedOrganicAlt} />
                </div>
              </div>
            </div>
            ...
            <div className={styles.timelineItem} data-aos="fade-up">
              ...
              <div className={`${styles.timelineContentWrapper} ${styles.timelineReverse}`}>
                ...
                <div className={styles.timelineImage}>
                  <img data-aos="fade-up" src="public\assets\Family Ministries.png" alt="New Leadership" className={styles.roundedOrganic} />
                </div>
              </div>
            </div>
          </div>
